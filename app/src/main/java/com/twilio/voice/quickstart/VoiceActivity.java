...
public class VoiceActivity extends AppCompatActivity {
    ...
    private static final String TWILIO_ACCESS_TOKEN_SERVER_URL = "http://fitlinkerapp.com/fitlinker_staging/public/index.php/api/generateToken";
...
//        TWILIO_ACCESS_TOKEN_SERVER_URL="http://fitlinkerapp.com/fitlinker_staging/public/index.php/api/"+"9e1cc9f46565cb217b712ad9dcc9da64";
    ...
    private Call.Listener callListener() {
        return new Call.Listener() {
            ...
            public void onConnected(Call call) {
                Log.e(TAG, "onConnected: "+ call.getState().toString());
                Log.e(TAG, "onConnected: "+ call.getFrom());
                Log.e(TAG, "onConnected: "+ call.getTo());
                setAudioFocus(true);
                Log.e(TAG, "Connected");
                activeCall = call;
            }
            ...
            public void onDisconnected(Call call, CallException error) {
                Log.e(TAG, "onDisconnected: "+ call.getState().toString());
                Log.e(TAG, "onDisconnected: "+ call.getFrom());
                Log.e(TAG, "onDisconnected: "+ call.getTo());
                setAudioFocus(false);
    ...
    private void disconnect() {
        Log.e(TAG, "disconnect: "+activeCall.getState().toString());
        if (activeCall != null) {
    ...
    private void retrieveAccessToken() {
        Ion.with(this).load(TWILIO_ACCESS_TOKEN_SERVER_URL + "?identity=" + identity).asString()
